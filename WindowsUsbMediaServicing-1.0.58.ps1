...
.PARAMETERS
  .\WindowsUsbMediaServicing-1.0.58.ps1
  ...
  .\WindowsUsbMediaServicing-1.0.58.ps1 -Gather -Boot -Install -UpdateMedia -Confirm 
...
.NOTES/REFERENCES
  ...
  4.16.2026 - Mass Updates to logic and features. v1.0.50
...
if($Folders -eq $True)
{
    ...
    $MntPath = "C:\Temp\Virtual\Media\Mount"
