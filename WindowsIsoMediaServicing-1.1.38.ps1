...
.PARAMETERS
  ...
  .\WindowsIsoMediaServicing-1.1.38.ps1
...
if ($Reset -eq "Resetting Servicing Environment") {
...
Write-Host "Updated .Iso available. Located - $MediaRoot" -ForegroundColor Green
}
